...
Performed by: Nguyễn Lê Hoàng Khải, Trần Lê Hoàng Gia | Reviewed by: All Members | Edited by: Nguyễn Lê Hoàng Khải, Trần Lê Hoàng Gia

## Table of Contents

- [Container and Component Diagram](#container-and-component-diagram)
  - [Table of Contents](#table-of-contents)
  - [1. C4 Model — Level 1: System Context Diagram](#1-c4-model--level-1-system-context-diagram)
    - [1.1 Main Flow](#11-main-flow)
    - [1.2 Person Descriptions](#12-person-descriptions)
  ...
  - [2. C4 Model — Level 2: Container Diagram](#2-c4-model--level-2-container-diagram)
    ...
    - [2.2 Container Descriptions](#22-container-descriptions)
    - [2.3 External System Descriptions](#23-external-system-descriptions)
  - [3. C4 Model — Level 3: Frontend Component Diagram](#3-c4-model--level-3-frontend-component-diagram)
    - [3.1 Main Flow](#31-main-flow)
    - [3.2 Frontend Component Descriptions](#32-frontend-component-descriptions)
  - [4. C4 Model — Level 3: Backend Core Business Component Diagram](#4-c4-model--level-3-backend-core-business-component-diagram)
    - [4.1 Main Flow](#41-main-flow)
    - [4.2 Backend Core Component Descriptions](#42-backend-core-component-descriptions)
  - [5. C4 Model — Level 3: Recommendation Subsystem Component Diagram](#5-c4-model--level-3-recommendation-subsystem-component-diagram)
    - [5.1 Main Flow](#51-main-flow)
    - [5.2 Recommendation Component Descriptions](#52-recommendation-component-descriptions)
  - [6. AI Usage Notes](#6-ai-usage-notes)
    - [AI Tool 1](#ai-tool-1)
    - [AI Tool 2](#ai-tool-2)
...
| External Image Hosts | External CDNs (e.g., Open Library) serving remote book covers and user-supplied avatar URLs. | HTTPS |
...
## 3. C4 Model — Level 3: Frontend Component Diagram
...
### 3.2 Frontend Component Descriptions
...
## 4. C4 Model — Level 3: Backend Core Business Component Diagram
...
### 4.2 Backend Core Component Descriptions
...
## 5. C4 Model — Level 3: Recommendation Subsystem Component Diagram
...
### 5.2 Recommendation Component Descriptions
