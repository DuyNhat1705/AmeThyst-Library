    ...
    <>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          {!isCurrent && (
            <div className="flex items-center gap-2">
              <span className="text-[11px] text-[#75777D] dark:text-neutral-400">From</span>
              ...
              <span className="text-[11px] text-[#75777D] dark:text-neutral-400">To</span>
      ...
      <div className="flex gap-2 pb-2">
        {(['current', 'history'] as const).map((t) => (
          <button key={t} onClick={() => { setTab(t); setSearch(''); setDateFrom(''); setDateTo(''); }}
          ...
          >
            {t === 'current' ? 'Currently Borrowing' : 'History'}
          </button>
        ))}
      </div>
