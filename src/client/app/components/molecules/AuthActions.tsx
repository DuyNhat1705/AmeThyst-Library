...
export default function AuthActions() {
  ...
  // Placeholder to avoid hydration mismatch by rendering a consistent layout size during SSR/hydration
  if (!mounted) {
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      {/* Settings Icon */}
      <button className="text-white hover:text-[#486C7E] transition-colors cursor-pointer focus:outline-none" aria-label={t('profile.settings_aria')}>
