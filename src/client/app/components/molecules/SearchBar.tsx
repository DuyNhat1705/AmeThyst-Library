...
export default function SearchBar() {
  return (
    <div className="w-full max-w-[896px] mx-auto bg-[#EFF4FF] rounded-2xl border-2 border-transparent shadow-sm p-4 flex items-center justify-between gap-4 mt-[-44px] relative z-10">
      {/* Search Input Group */}
      ...
      {/* Filter Button */}
      <Button variant="outline" className="flex items-center gap-2 py-2 px-4 h-auto rounded-xl">
        <svg
          width="18"
          height="12"
          viewBox="0 0 18 12"
