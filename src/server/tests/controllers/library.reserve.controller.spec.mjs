...
describe('library.controller.mjs - reserveBook', () => {
  ...
  describe('Test 1 - Successful reservation', () => {
    it('should return 201 with the created reservation', async () => {
    ...
    it('should pass bookId and branchId as-is to the service', async () => {
  ...
  describe('Test 2 - Missing parameters', () => {
    it('should return 400 MISSING_PARAMETERS when bookId is missing', async () => {
      req.body = { branchId: 1 };
    ...
    it('should return 400 MISSING_PARAMETERS when branchId is missing', async () => {
    ...
    it('should return 400 MISSING_PARAMETERS when both bookId and branchId are missing', async () => {
      req.body = {};
  ...
  describe('Test 3 - Service-level domain errors', () => {
    it('should forward USER_NOT_FOUND error with its status code', async () => {
      createReservation.mockResolvedValue({
    ...
    it('should forward BOOK_UNAVAILABLE error with its status code', async () => {
      createReservation.mockResolvedValue({
    ...
    it('should default to status 400 when the service error has no statusCode', async () => {
      createReservation.mockResolvedValue({
  ...
  describe('Test 5 - Data-shape invariants', () => {
    it('should never leak raw error messages on unexpected exceptions', async () => {
