import { verifyPin as verifyPinService, confirmBorrowing as confirmBorrowingService, cancelBorrowing as cancelBorrowingService, getPickupsService } from '../services/dashboard.librarian.services.mjs';
...
export { getPickups, verifyPin, confirmBorrowing, cancelBorrowing };
