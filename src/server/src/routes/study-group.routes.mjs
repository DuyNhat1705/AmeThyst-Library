...
router.post('/', verifyToken, validateCreateStudyGroup, controller.createStudyGroupController);
...
router.post('/:groupId/requests', verifyToken, validateStudyGroupParams, validateJoinRequest, controller.requestToJoinController);
...
router.post('/:groupId/invitations', verifyToken, validateStudyGroupParams, validateInvitation, controller.inviteStudyGroupMemberController);
