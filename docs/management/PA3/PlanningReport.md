...
- Implement 2 Functional Groups using Spec Kit (25 points) - **Done**
  - Functional groups chosen to propose are Profile Management and Books
...
## II. Task assignment
- **Vũ Duy Nhất**
  - Overview and Merge Code - 2/8
  - Deployment Diagram (5 points) - Due date: 8/8
  - Complete a video with narration explaining the implemented feature (Profile Management and Books) - Due date: 8/8
  - AI Usage Report + Weekly Report (5 points) - Due date: 8/8
- **Trần Lê Hoàng Gia**
  - Complete Statistics Page in Admin Administration (GUI + Functionality) - Due date: 1/8
...
- Deeply understand the product's architecture and tech stack through C4 models.
- Propose 2 more completed functional groups, Profile Management and Books, in the video uploaded to Youtube.