...
- **Prompt**: “Assure the consistency of C4 system context diagram with Vision Document, and deeper level C4 diagram. Provide the description and explanation of the diagram components.”
