...
- **Status Report:**
  ...
  - **Phan Lê Anh Minh**
    ...
    - Obstacle/Issues
      - Need to add more fields into users table and open admin_log table to fully implement the feature.
  - **Nguyễn Nhựt Huy**
    - Completed task
...
- **Status Report:**
  ...
  - **Nguyễn Nhựt Huy**
    ...
    - Obstacles/Issues:
      - Need to add more fields into users table and open authorize_history table to fully implement the feature.
  - **Nguyễn Lê Hoàng Khải**
    - Completed task
      - Software Architecture: Container Diagram and Component Diagram (20 points)
    - To-do task
